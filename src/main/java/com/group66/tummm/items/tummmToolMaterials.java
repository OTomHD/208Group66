...
public enum tummmToolMaterials implements ToolMaterial {
    ...
    private tummmToolMaterials(int miningLevel, int itemDurability, float miningSpeed, float attackDamage, int enchantability, Supplier<Ingredient> repairIngredient) {
